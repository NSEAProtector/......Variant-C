...
/mob/living/silicon/verb/pose()
	...
	pose =  sanitize_rus(copytext(input(usr, "This is [src]. It is...", "Pose", null)  as text, 1, MAX_MESSAGE_LEN))
...
/mob/living/silicon/verb/set_flavor()
	...
	flavor_text =  sanitize_rus(input(usr, "Please enter your new flavour text.", "Flavour text", null)  as text)
