...
/obj/item/weapon/photo/attackby(obj/item/weapon/P as obj, mob/user as mob, params)
	if(istype(P, /obj/item/weapon/pen) || istype(P, /obj/item/toy/crayon))
		var/txt = sanitize_rus(input(user, "What would you like to write on the back?", "Photo Writing", null)  as text)
...
/obj/item/weapon/photo/verb/rename()
	...
	var/n_name = sanitize_rus(copytext(input(usr, "What would you like to label the photo?", "Photo Labelling", name) as text, 1, MAX_MESSAGE_LEN))
